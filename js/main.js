...
const productArr=product.products;

(function setData(){
   
      let row=document.getElementById('informations')
      let countnumbers=document.getElementById('count')
      let container=``
      for( let i=0;i<productArr.length;i++){
        container+=`  <div class="colum">
        <div class="productInfo">
            ...
            <div class="price">
                <p>${productArr[i].rating}</p>
                <p>${productArr[i].price}$</p>
            </div>
            <div class="productName">
                <p>${productArr[i].name}</p>
                <span>${productArr[i].brand}</span>
            </div>
            <div class="btns">
                <button id="love"><a href=""><i class="fab fa-gratipay"></i>wish list</a></button>
                <button id="wish"><a href=""><i class="fas fa-shopping-cart"></i> view in chart</a></button>
            </div>
      ...
      countnumbers.innerHTML=`${productArr.length}  Result Found`
 ...
 function searchProduct(term){
    ...
    for(i=0;i<productArr.length;i++){
        ...
        productArr[i].brand.toLowerCase().includes(term.toLowerCase()) == true){
        ...
        countnumbers.innerHTML=`${searchArr.length}  Result Found`
        document.getElementById('informations').innerHTML=container;
    }
    
}
function getLowToHighProduct(){
    const sortingArr= productArr.sort((a, b) => parseFloat(a.price) - parseFloat(b.price));
    let row=document.getElementById('informations')
    let countnumbers=document.getElementById('count')
    let container=``
    for( let i=0;i<sortingArr.length;i++){
      ...
      <div class="productInfo">
          <div class="pImage">
              <img src="${sortingArr[i].img}" alt="">
         
          </div>
          <div class="price">
              <i  class="${sortingArr[i].rating}"></i>
              <p>${sortingArr[i].price}$</p>
          </div>
          <div class="productName">
              <p>${sortingArr[i].name}</p>
              <span>${sortingArr[i].brand}</span>
          </div>
          <div class="btns">
              <button id="love"><a href=""><i class="fab fa-gratipay"></i>wish list</a></button>
              <button id="wish"><a href=""><i class="fas fa-shopping-cart"></i> view in chart</a></button>
    ...
    countnumbers.innerHTML=`${sortingArr.length}  Result Found`
   
    row.innerHTML=container;
  
}

function getHighToLowProduct(){
    const sortingArr= productArr.sort((a, b) =>   parseFloat(b.price)-parseFloat(a.price));
    let row=document.getElementById('informations')
    let countnumbers=document.getElementById('count')
    let container=``
    for( let i=0;i<sortingArr.length;i++){
...
function getProduct(){
   const featuredArr=productArr.sort()
   let row=document.getElementById('informations')
    let countnumbers=document.getElementById('count')
    console.log('ok')
    let container=``
    for( let i=0;i<featuredArr.length;i++){
      ...
      <div class="productInfo">
          <div class="pImage">
              <img src="${featuredArr[i].img}" alt="">
         
          </div>
          <div class="price">
              <i  class="${featuredArr[i].rating}"></i>
              <p>${featuredArr[i].price}$</p>
          </div>
          <div class="productName">
              <p>${featuredArr[i].name}</p>
              <span>${featuredArr[i].brand}</span>
          </div>
          <div class="btns">
              <button id="love"><a href=""><i class="fab fa-gratipay"></i>wish list</a></button>
              <button id="wish"><a href=""><i class="fas fa-shopping-cart"></i> view in chart</a></button>
    ...
    console.log('outside')
    countnumbers.innerHTML=`${featuredArr.length}  Result Found`
   
    row.innerHTML=container;
   console.log('done')

}
 function filterProduct (term){
     let ArrayOfProduct=[]
     searchValue=Number(term)
     if(searchValue == 0){
         ArrayOfProduct==productArr
         let row=document.getElementById('informations')
         let countnumbers=document.getElementById('count')
         let container=``
         for( let i=0;i<productArr.length;i++){
         ...
         ArrayOfProduct=productArr.filter(productArr => productArr.price <= 10)
         console.log(ArrayOfProduct)
     }
     else if(searchValue == 2){
        ArrayOfProduct=productArr.filter(productArr => productArr.price > 10 && productArr.price <=100)
        console.log(ArrayOfProduct)
    }
